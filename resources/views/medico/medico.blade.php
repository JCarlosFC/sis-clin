            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    <div class="form-group col-md-10">
                        <nav class="navbar navbar-light bg-light float-right">
                            <form class="form-inline" method="GET" action="{{ route('medico.search') }}">
                    ...
                    <div class="form-group col-md-8">
                        <nav class="navbar navbar-light bg-light float-right">
                            <form class="form-inline" method="GET" action="{{ route('medico.search') }}">
                                <input name="verify" type="hidden" value="1">
                                <input name="codigo" class="form-control mr-sm-2 @error('name') is-invalid @enderror" type="search" placeholder="código" aria-label="Search">
                                <button class="btn btn-outline-info my-2 my-sm-0" type="submit">Buscar</button>
                            </form>
                        </nav>
                    </div>
                ...
                <div class="form-group col-md-10">
                    <div class="offset-md-5">
                        <p>Si no encuentra al médico usted puede</p>
